...
export const orderRazorPayReducer =  (state = { paymentDetails: {} }, action) => {
    switch(action.type){

        case ORDER_RAZOR_PAY_REQUEST:
            return {
                loading: true 
            }

        case ORDER_RAZOR_PAY_SUCCESS:
            return {
                loading: false,
                success: true,
        ...
        case ORDER_RAZOR_PAY_FAIL:
            return {
                loading: false,
                error: action.payload
            }

            case ORDER_RAZOR_PAY_RESET:
                return {}
